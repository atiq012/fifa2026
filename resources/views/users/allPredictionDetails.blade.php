    ...
    <div id="predictions" class="screen active">
        ...
        <div class="row">
            @foreach ($predictions as $prediction)
                <div class="col-md-4">
                    <div class="prediction-card" style="opacity: 0.8; overflow: hidden;">
                        <div style="display: flex; justify-content: space-between; align-items: center; background: linear-gradient(135deg, #f8f9fb 0%, #eef1f6 100%); border-radius: 10px 10px 0 0; padding: 10px 12px; margin: -1rem -1rem 1rem -1rem;">
                            @php
                                $emp = DB::table('emps')->where('id', $prediction->createdBy->emp_id)->first();
                                $favFlag = $prediction->createdBy->team?->team?->flag ?? null;
                            ...
                            <div class="d-flex align-items-center gap-2">
                                ...
                                <span style="font-size: 11px; color: #888780; background: #f1efe8; padding: 4px 8px; border-radius: 6px;">{{ $prediction->createdBy->name }}</span>
                            </div>
                            @if($favFlag)
                        ...
                        <h3 style="margin: 0 0 1rem; font-size: 15px; font-weight: 500; color: #2c2c2a;">
                            <div class="d-flex align-items-center">
                                ...
                                <div class="ms-auto d-flex align-items-center gap-1">
                                    <img src="{{ asset('images/football.svg') }}" width="16" height="16" alt="">
